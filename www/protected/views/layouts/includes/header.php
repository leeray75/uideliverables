<div class="row">
  <nav id="UI-Deliverables-Nav" class="navbar navbar-default navbar-fixed-top navbar-inverse">
    <div class="navbar-header">
    	<div class="ui-logo visible-xs">
    	<a href="/www/"> <img alt="UI Deliverables" src="/www/content/images/logos/UI-Deliverables.png" class="ui-logo-lg" ><img alt="UI" src="/www/content/images/logos/UI-Deliverables-sm.png" class="img-responsive ui-logo-sm" ></a>
        </div>
